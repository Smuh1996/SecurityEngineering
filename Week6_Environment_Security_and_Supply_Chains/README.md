...
Outsourced Manufacturing: Outsourcing of manufacturing of components may present a risk of having the modified by some mischievous individuals. The blamed facilities are not secure enough or not enough overseen, which means that insecure parts could be integrated into end products.
